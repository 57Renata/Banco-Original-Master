...
public class Steps {
	...
	@Given("selecionar o botão abrir conta para sua empresa")
	public void selecionar_o_botão_abrir_conta_para_sua_empresa() {
	    m.clicar(e.getAbrirContaPJ());
	}
	@Given("abrir conta pessoa unica")
	public void abrir_conta_pessoa_unica() {
		m.clicar(e.getAbrirContaPessoaUnica());   
	}
	...
	@Given("selecionar o botao ok")
	public void selecionar_o_botao_ok() {
	    m.clicar(e.getBtnOk());
	}
